    ...
    <div className="z-0">
      <div className="" data-aos="zoom-in">
        ...
        >
          ...
          <SwiperSlide>
            <div>
              <div className="lg:min-h-[900px] min-h-[600px]  bg-[url('https://i.ibb.co/C0VgqRf/meal-together.png')] bg-no-repeat bg-cover bg-center flex justify-center items-center py-8 md:py-0">
                {/* Slider left Section */}
                <div className="w-full mx-auto flex flex-col   justify-center items-center md:gap-10 gap-4 p-2 absolute h-full  md:bg-gradient-to-r bg-gradient-to-t from-[#191919fa]  to-[rgba(21, 21, 21, 0.00)]  ">
                  <div className="md:w-2/3 text-center text-white">
                    <h3 className="md:text-3xl text-2xl font-semibold text-[#87ff24f1] animate__animated animate__fadeInTopLeft  animate__slow">
          ...
          <SwiperSlide>
            <div>
              <div className="lg:min-h-[900px] min-h-[600px]  bg-[url('https://i.ibb.co/ZfGKrzp/hostel-mess.jpg')] bg-no-repeat bg-cover bg-center flex justify-center items-center py-8 md:py-0">
                {/* Slider left Section */}
                <div className="w-full mx-auto flex flex-col   justify-center items-center md:gap-10 gap-4 p-2 absolute h-full  md:bg-gradient-to-r bg-gradient-to-t from-[#191919fa]  to-[rgba(21, 21, 21, 0.00)]  ">
                  <div className="md:w-2/3 text-center text-white">
                    <h3 className="md:text-3xl text-2xl font-semibold text-[#87ff24f1] animate__animated animate__fadeInTopLeft  animate__slow">
